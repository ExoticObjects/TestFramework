...
Pod::Spec.new do |s|
  ...
  s.author             = { "Avner Barr" => "avner@insert.io" }
  # Or just: s.author    = "Avner Barr"
  # s.authors            = { "Avner Barr" => "avner@insert.io" }
  # s.social_media_url   = "http://twitter.com/Avner Barr"
  ...
  s.source       = { :git => "https://github.com/avnerbarr/TestFramework.git", :tag => "0.0.3" }
